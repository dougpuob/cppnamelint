...
TEST(General, Fake_WhiteList)
{
    ...
    EXPECT_EQ(true,
              pWhiteList->FunctionPrefix.end() != std::find(pWhiteList->FunctionPrefix.begin(),
                                                            pWhiteList->FunctionPrefix.end(), "_"));
    EXPECT_EQ(true, pWhiteList->FunctionPrefix.end() !=
                        std::find(pWhiteList->FunctionPrefix.begin(),
                                  pWhiteList->FunctionPrefix.end(), "__"));
